<template>
    <transition name="move">
     <div v-show="showFlag" class="food" ref="food">
          ...
          <split></split>
          <div class="rating" style="padding-bottom:50px">
              <h1 class="title">商品评价</h1>
              <ratingselect :select-type="selectType" :only-content="onlyContent" 	@ratingtype-select="changeSelectType"
			    		@content-toggle="toggleOnlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
